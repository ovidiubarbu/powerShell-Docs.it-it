...
Per attività semplici e singole, è possibile usare [Invoke-Command](https://msdn.microsoft.com/powershell/reference/5.1/microsoft.powershell.core/invoke-command) per eseguire un set di comandi tramite JEA.
