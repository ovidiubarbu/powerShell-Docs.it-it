...
Nella barra degli strumenti fare clic su **Esegui script** o scegliere **Esegui** dal menu **File**..

### Per eseguire una parte di uno script

1.  Nel riquadro di script selezionare una parte di uno script.

2.  Nella barra degli strumenti fare clic su **Esegui selezione** o scegliere **Esegui selezione** dal menu **File**..
