...
|--------------------|-----------|--------------------------|
|\-e|AND logico; true se i valori a entrambe le estremità sono true|(1 \-eq 1) \-and (2 \-eq 2)|
|\-o|OR logico; true se i valori a entrambe le estremità sono true|(1 \-eq 1) \-or (1 \-eq 2)|
