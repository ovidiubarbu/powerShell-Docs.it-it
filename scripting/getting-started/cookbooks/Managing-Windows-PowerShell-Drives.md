...
Ad esempio, è possibile creare un'unità denominata "Office" mappata alla cartella contenente le applicazioni Microsoft Office nel computer, come **C:\Program Files\Microsoft Office\OFFICE11**. Per creare l'unità, digitare il comando seguente:
