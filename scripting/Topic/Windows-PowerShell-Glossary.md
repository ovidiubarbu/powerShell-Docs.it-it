...
|Flusso di lavoro di [!INCLUDE[wps_2](../Token/wps_2_md.md)]|Un flusso di lavoro è una sequenza di passaggi programmati e connessi che consentono di eseguire attività di lunga durata o richiedono il coordinamento di più passaggi tra più dispositivi o nodi gestiti. Il flusso di lavoro di [!INCLUDE[wps_2](../Token/wps_2_md.md)] consente a professionisti IT e sviluppatori di creare sequenze di attività di gestione di più dispositivi o singole attività all'interno di un flusso di lavoro, come flussi di lavoro. Il flusso di lavoro di [!INCLUDE[wps_2](../Token/wps_2_md.md)] consente di adattare ed eseguire sia script di [!INCLUDE[wps_2](../Token/wps_2_md.md)] che file XAML come flussi di lavoro.|
