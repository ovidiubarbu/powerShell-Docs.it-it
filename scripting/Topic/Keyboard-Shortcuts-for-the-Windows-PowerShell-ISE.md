...
Per eseguire le azioni in [!INCLUDE[ise_1](../Token/ise_1_md.md)], usare i seguenti tasti di scelta rapida: [!INCLUDE[ise_2](../Token/ise_2_md.md)] è disponibile nell'ambito dei sistemi operativi Windows Server e client Windows, ma può anche essere installato in alcuni sistemi operativi Windows precedenti nell'ambito del [pacchetto di download di Windows Management Framework 4.0](http://go.microsoft.com/fwlink/?LinkID=293881).
...
È possibile usare i tasti di scelta rapida seguenti per avviare la console di Windows PowerShell (PowerShell.exe) o per uscire da [!INCLUDE[ise_2](../Token/ise_2_md.md)].
