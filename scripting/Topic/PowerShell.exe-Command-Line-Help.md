...
### -Mta
Avvia Windows PowerShell usando un apartment a thread multipli. [!INCLUDE[ps_sdk_paramintrodps3](../Token/ps_sdk_paramintrodps3_md.md)] In [!INCLUDE[psversion3](../Token/psversion3_md.md)] l'impostazione predefinita è apartment a thread singolo (STA). In [!INCLUDE[psversion2](../Token/psversion2_md.md)] l'impostazione predefinita è apartment a thread multipli (MTA).
...
Avvia la versione specificata di Windows PowerShell. La versione specificata deve essere installata nel sistema. Se [!INCLUDE[psversion3](../Token/psversion3_md.md)] è installato nel computer, i valori validi sono "2.0" e "3.0". Il valore predefinito è "3.0".
