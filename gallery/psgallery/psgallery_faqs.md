...
## Quali sono le differenze tra gli script e i moduli di PowerShell?
...
- [Don't Write Scripts, Write PowerShell Modules (Non scrivere script, ma moduli di PowerShell)](http://blogs.technet.com/b/heyscriptingguy/archive/2011/06/27/don-t-write-scripts-write-powershell-modules.aspx)
- [Understanding PowerShell Modules (Informazioni sui moduli di PowerShell)](http://blogs.technet.com/b/heyscriptingguy/archive/2015/07/10/understanding-powershell-modules.aspx)

## Come si pubblica in PowerShell Gallery?
...
## Perché non riesco ad accedere con l'account personale che ieri funzionava?
...
## Perché non sono visualizzati tutti gli elementi della raccolta quando si selezionano tutte le caselle di controllo Category (Categoria) nella scheda Items (Elementi)?
...
## Quali sono i requisiti per la pubblicazione di un modulo in PowerShell Gallery?
...
## Come si crea un manifesto del modulo formattato correttamente?
...
## Quali sono i requisiti per la pubblicazione di uno script nella raccolta?
...
## Come si crea un file di script formattato correttamente?
...
## Quali altri tipi di moduli di PowerShell esistono?
...
## Qual è la relazione tra PackageManagement e PowerShellGet? (Risposta di alto livello)
...
## Qual è la relazione tra NuGet e PowerShellGet?
...
## Significa che è possibile usare NuGet.exe per lavorare con la raccolta?

Sì.

## Qual è la modalità effettiva di relazione tra PackageManagement e PowerShellGet? (Dettagli tecnici)
...
## Quali sono i requisiti per l'esecuzione di PowerShellGet?
...
## È possibile riservare i nomi per elementi che verranno pubblicati in futuro?

Non è possibile prenotare i nomi degli elementi. Se si ritiene che il nome di un elemento esistente sia più appropriato per il proprio elemento, provare a [contattare il proprietario dell'elemento](psgallery_contacting_item_owners.md). Se si non ottiene risposta entro un paio di settimane, è possibile contattare il supporto e il team di PowerShell Gallery analizzerà il problema.

## Come è possibile richiedere la proprietà per gli elementi?

Per informazioni dettagliate, vedere [Managing Item Owners on PowerShellGallery.com](Managing-Item-Owners.md) (Gestione dei proprietari di elementi in PowerShellGallery.com).

## Come si gestisce una situazione in cui il proprietario di un elemento sta violando la licenza dell'elemento dell'utente?
