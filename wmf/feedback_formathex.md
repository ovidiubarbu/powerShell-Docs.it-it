# Format-Hex
**Format-Hex** consente di visualizzare dati di testo o binari in formato esadecimale. Ecco un esempio di rappresentazione esadecimale di una stringa e del contenuto binario di un documento di Word.
