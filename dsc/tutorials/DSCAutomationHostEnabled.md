...
DSC Usa la **DSCAutomationHostEnabled** chiave di registro **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System** per abilitare la configurazione della macchina al iniziale avvio.
