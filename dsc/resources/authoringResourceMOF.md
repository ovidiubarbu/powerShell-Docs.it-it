...
* `Values` limita i valori che possono essere assegnati alla proprietà all'elenco di valori definiti in `ValueMap`. Per altre informazioni, vedere l'articolo relativo ai [qualificatori ValueMap e Value](/windows/desktop/WmiSdk/value-map).
