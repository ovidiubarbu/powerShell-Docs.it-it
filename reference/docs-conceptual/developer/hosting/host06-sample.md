...
Questo esempio illustra come compilare un'applicazione host basata su console interattiva che legge i comandi dalla riga di comando, esegue i comandi e quindi Visualizza i risultati nella console. Questo esempio usa inoltre le API del tokenizer per specificare il colore del testo immesso dall'utente.

## <a name="requirements"></a>Requisiti

- Questo esempio richiede Windows PowerShell 2,0.

- Questa applicazione deve essere eseguita in modalità con privilegi elevati (Esegui come amministratore).

## <a name="demonstrates"></a>Dimostra

- Creazione di un host personalizzato le cui classi derivano dalla classe [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) , dalla classe [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) e dalla [classe Classe System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) .

- Compilazione di un'applicazione console che usa queste classi host per compilare una shell interattiva di Windows PowerShell.

- Creazione di una variabile `$profile` e caricamento dei seguenti profili.
...
- Implementare l'interfaccia [System. Management. Automation. host. Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) .

- Implementare l'interfaccia [System. Management. Automation. host. Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) per supportare la comunicazione remota interattiva usando i cmdlet [Enter-PSSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) e [Exit-PSSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) .

- Usare l'API tokenize per colorare la riga di comando mentre è tipizzata.

## <a name="example"></a>Esempio

 Questo esempio consente all'utente di immettere comandi dalla riga di comando, elabora tali comandi e quindi stampa i risultati.
...
## <a name="example"></a>Esempio
 ...
 Il codice seguente è l'implementazione della classe [System. Management. Automation. host. PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) usata da questa applicazione host. Gli elementi che non sono implementati generano un'eccezione o non restituiscono alcun valore.
...
## <a name="example"></a>Esempio
 ...
 Il codice seguente è l'implementazione della classe [System. Management. Automation. host. Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) usata da questa applicazione host.
...
## <a name="example"></a>Esempio
 ...
 Il codice seguente è l'implementazione della classe [System. Management. Automation. host. Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) usata da questa applicazione host. Gli elementi che non sono implementati generano un'eccezione o non restituiscono alcun valore.
...
## <a name="example"></a>Esempio
 ...
 Il codice seguente legge la riga di comando e colora il testo quando viene immesso. I token vengono determinati tramite il metodo [System. Management. Automation. Psparser. tokenize *](/dotnet/api/System.Management.Automation.PSParser.Tokenize) .
