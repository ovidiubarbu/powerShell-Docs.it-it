...
- Creazione di un oggetto [System. Management. Automation. Commandmetadata](/dotnet/api/System.Management.Automation.CommandMetadata) che descrive i metadati di un cmdlet esistente.
...
- Modifica dei metadati del cmdlet per rimuovere un parametro del cmdlet.

- Aggiunta del cmdlet all'oggetto [System. Management. Automation. Runspaces. InitialSessionState](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) e rendendo privato il cmdlet.

- Creazione di una funzione proxy che chiama il cmdlet esistente, ma espone solo un set di parametri limitato.

- Aggiunta della funzione proxy allo stato sessione iniziale.
...
- Chiamare il cmdlet private e la funzione proxy usando un oggetto [System. Management. Automation. PowerShell](/dotnet/api/system.management.automation.powershell) per illustrare il spazio vincolato.

## <a name="example"></a>Esempio

Viene creato un comando proxy per un cmdlet privato per illustrare un spazio vincolato.
