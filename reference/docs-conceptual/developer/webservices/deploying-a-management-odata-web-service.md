...
Dopo aver completato tutti i passaggi necessari per creare un servizio Web OData di gestione, è necessario distribuirlo come applicazione Web in IIS.
...
4. Creare e configurare un pool di app.
...
Gli script di Windows PowerShell seguenti illustrano come distribuire un servizio Web OData di gestione.
