...
L'utente può visualizzare gli errori in base alla relativa categoria impostando la variabile `$ErrorView` su "CategoryView".
...
Questa operazione può essere eseguita definendo i parametri `ErrorAction` e `ErrorVariable`.
