...
Specifica il numero di caratteri spostati al di fuori del margine destro da parte dei dati. Questo elemento viene usato quando si definisce un controllo comune che può essere usato da tutte le visualizzazioni nel file di formattazione.
