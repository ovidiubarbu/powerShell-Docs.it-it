...
Nelle sezioni seguenti vengono descritti gli attributi, gli elementi figlio e l'elemento padre dell'elemento `ShowError`. Il valore predefinito per questo elemento è `false`.
