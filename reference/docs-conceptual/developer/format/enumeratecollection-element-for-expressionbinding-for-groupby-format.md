...
Specifica che gli elementi delle raccolte vengono visualizzati. Questo elemento viene utilizzato quando si definisce la modalità di visualizzazione di un nuovo gruppo di oggetti.
