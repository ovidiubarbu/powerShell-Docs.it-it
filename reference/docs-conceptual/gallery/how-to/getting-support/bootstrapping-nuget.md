...
Copiare le cartelle e il file usando un processo attendibile nei computer offline. Per usare il provider nel computer offline, è necessario importarlo. Eseguire il comando seguente nel computer offline:
