...
Per altre informazioni sull'uso di Windows PowerShell ISE, vedere [Esplorazione di Windows PowerShell ISE](../getting-started/fundamental/exploring-the-windows-powershell-ise.md).
