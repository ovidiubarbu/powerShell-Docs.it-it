...
## <a name="stopping-processes-stop-process"></a><span data-ttu-id="bd3c2-123">Arresto dei processi (Stop-Process)</span><span class="sxs-lookup"><span data-stu-id="bd3c2-123">Stopping Processes (Stop-Process)</span></span>
