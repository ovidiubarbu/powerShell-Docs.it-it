...
#### <a name="storing-objects-in-variables"></a><span data-ttu-id="c6e80-123">Archiviazione di oggetti nelle variabili</span><span class="sxs-lookup"><span data-stu-id="c6e80-123">Storing Objects in Variables</span></span>
