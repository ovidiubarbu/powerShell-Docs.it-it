...
## <a name="using-the-composite-resource"></a><span data-ttu-id="f7b3a-124">Uso della risorsa composita</span><span class="sxs-lookup"><span data-stu-id="f7b3a-124">Using the composite resource</span></span>
