...
#### <a name="on-the-authoring-node-import-the-certs-public-key"></a>Nel nodo di creazione: importare la chiave pubblica del certificato
...
#### <a name="on-the-target-node-import-the-certs-private-key-as-a-trusted-root"></a>Nel nodo di destinazione: importare la chiave privata del certificato come radice attendibile
