...
### <a name="filtering-items-by-name--name"></a><span data-ttu-id="8a2be-119">Filtraggio degli elementi per nome (-Name)</span><span class="sxs-lookup"><span data-stu-id="8a2be-119">Filtering Items by Name (-Name)</span></span>
