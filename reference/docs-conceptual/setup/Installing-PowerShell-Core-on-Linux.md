...
Scaricare il pacchetto Debian `powershell_6.0.3-1.ubuntu.14.04_amd64.deb`
...
Scaricare il pacchetto Debian `powershell_6.0.3-1.ubuntu.16.04_amd64.deb`
dalla pagina delle [versioni][] nel computer Ubuntu.
...
Scaricare il pacchetto Debian `powershell_6.1.0-preview.3-1.ubuntu.18.04_amd64.deb`
dalla pagina delle [versioni][] nel computer Ubuntu.
...
Scaricare il pacchetto Debian `powershell_6.0.3-1.debian.8_amd64.deb`
...
Scaricare il pacchetto Debian `powershell_6.0.3-1.debian.9_amd64.deb`
dalla pagina delle [versioni][] nel computer Debian.
...
Usando [CentOS 7][], scaricare il pacchetto RPM `powershell-6.0.3-1.rhel.7.x86_64.rpm`
...
Scaricare il pacchetto RPM `powershell-6.0.3-1.rhel.7.x86_64.rpm`
...
Scaricare il pacchetto RPM `powershell-6.0.3-1.rhel.7.x86_64.rpm` dalla pagina delle [versioni][] nel computer OpenSUSE.
...
* `$PSHOME` è `/opt/microsoft/powershell/6.0.3/`
