...
---
# <a name="runspace11-sample"></a>Esempio di Runspace11
...
- Creazione di un [System.Management.Automation.Commandmetadata](/dotnet/api/System.Management.Automation.CommandMetadata) oggetto che descrive i metadati di un cmdlet esistente.
...
- Modifica i metadati di cmdlet per rimuovere un parametro del cmdlet.

- Aggiunta di cmdlet per il [System.Management.Automation.Runspaces.Initialsessionstate](/dotnet/api/System.Management.Automation.Runspaces.InitialSessionState) oggetto e rendere privato il cmdlet.

- Creazione di una funzione di proxy che chiama il cmdlet esistente, ma espone solo un set limitato di parametri.

- Aggiunta della funzione di proxy per lo stato sessione iniziale.
...
- Chiamare il cmdlet privato e la funzione di proxy utilizzando un [System.Management.Automation.Powershell](/dotnet/api/system.management.automation.powershell) oggetto per illustrare lo spazio di esecuzione vincolato.

## <a name="example"></a>Esempio

Ciò consente di creare un comando proxy per un cmdlet privato illustrare un spazio di esecuzione vincolato.
