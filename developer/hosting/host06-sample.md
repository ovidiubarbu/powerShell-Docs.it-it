...
- Usare l'API di suddividere in token per colorare la riga di comando com'è digitato.
...
## <a name="example"></a>Esempio
 ...
 Il codice seguente legge la riga di comando e i colori del testo quando viene inserita. I token vengono determinati usando la [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) (metodo).
