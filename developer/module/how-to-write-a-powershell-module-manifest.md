...
|DotNetFrameworkVersion<br /><br /> Tipo: string|' '|Versione minima di Microsoft .NET Framework richiesta da questo modulo.<br /><br /> Esempio: `DotNetFrameorkVersion = '3.5'`|
