...
È possibile usare gli oggetti esposti dallo spazio dei nomi N:Microsoft.PowerShell.ScheduledJob per creare un processo pianificato, definire quando è in esecuzione e ottenere risultati relativi al processo completato dopo l'esecuzione.

## <a name="triggering-the-job"></a>Attivazione del processo

Specifica il primo passaggio nella creazione di un processo pianificato quando il processo da eseguire. Eseguire questa operazione creando e configurando un T:Microsoft.PowerShell.ScheduledJob.ScheduledJobTriggerobject. Il codice seguente crea un trigger che consente di pianificare un processo per eseguire una sola volta in futuro di 20 secondi.
...
Per definire un processo di Windows PowerShell, la creazione di un dizionario di parametri. I parametri seguenti sono supportati.

|Nome parametro|Description|
|---|---|
|Nome|Il nome del processo.|
|ScriptBock|Un blocco di script di Windows PowerShell che specifica ciò che non è il processo.|
|FilePath|Un percorso di un file che contiene blocchi di script Windows PowerShell che specifica ciò che non è il processo.|
|InitializationScript|Un blocco di script di Windows PowerShell che consente di inizializzare il processo.|
...
Il codice seguente crea un oggetto dizionario di parametri e imposta i parametri Name e ScriptBlock.
...
## <a name="creating-the-invocation-and-job-definition-objects"></a>Creazione di chiamata e gli oggetti di definizione processo

È quindi possibile creare oggetti ScheduledJobInvicationInfo e SheduledJobDefinition per eseguire il processo. Il codice seguente viene illustrata questa.
...
Il codice seguente registra il processo con l'utilità di pianificazione di Windows.
