...
Specifica il primo passaggio nella creazione di un processo pianificato quando il processo da eseguire. Eseguire questa operazione creando e configurando un oggetto T:Microsoft.PowerShell.ScheduledJob.ScheduledJobTrigger. Il codice seguente crea un trigger che consente di pianificare un processo per eseguire una sola volta in futuro di 20 secondi.
...
È quindi possibile creare oggetti ScheduledJobInvocationInfo e ScheduledJobDefinition per eseguire il processo. Il codice seguente viene illustrata questa.
