...
---
# <a name="accessdbprovidersample03-code-sample"></a>Codice di esempio di AccessDbProviderSample03

Il codice seguente viene illustrata l'implementazione del provider di Windows PowerShell descritto nella [creazione di un Provider di Windows PowerShell](./creating-a-windows-powershell-item-provider.md). Questo provider che consente di modificare i dati in un archivio dati.
