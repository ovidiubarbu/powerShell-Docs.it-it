...
Estensione IIS OData gestione utilizza i file XML per definire i mapping delle risorse. Lo schema XSD seguente definisce lo schema utilizzato per questi file.

## <a name="resource-mapping-file-xsd"></a>Risorsa File di Mapping XSD

Lo schema XSD seguente definisce lo schema per i file di mapping di estensione IIS OData Gestione risorse.
