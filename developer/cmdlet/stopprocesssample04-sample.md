...
In questo esempio viene illustrato come scrivere un cmdlet che dichiara i set di parametri, specifica il parametro predefinito impostato e può accettare un oggetto di input. Questo cmdlet è simile al `Stop-Process` cmdlet forniti da Windows PowerShell 2.0.

### <a name="how-to-build-the-sample-by-using-visual-studio"></a>Come compilare l'esempio mediante Visual Studio.

1. Con Windows PowerShell 2.0 SDK installato, passare alla cartella StopProcessSample04. Il percorso predefinito è C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\StopProcessSample04.
...
- Aggiunta di un parametro che accetta oggetti di input.

- Aggiunta di parametri al set di parametri

- Specifica il parametro predefinito di set.

## <a name="example"></a>Esempio

Il codice seguente viene illustrata un'implementazione del cmdlet Stop-Process che dichiarare set di parametri, specifica il parametro predefinito impostato e può accettare un oggetto di input.

Questo esempio viene illustrato come specificare il parametro predefinito impostato per usare l'oggetto di input e come dichiarare set di parametri.
